...
} from "./actions/inventory-items.js";

// MemNavBlock: opens the mem-picked product's detail page. waygraph auto
// lists one "Open … details" row per inventory card (not only the first item).
